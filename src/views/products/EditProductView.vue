        ...
        <form @submit.prevent="submitForm">
          <div class="row gy-3 gx-5">
            <div class="col-md-6">
              ...
              <p v-if="err.title" class="text-danger m-0 mt-2">{{ err.title }}</p>
            </div>
            ...
            <div class="col-md-6">
              ...
              <p v-if="err.price" class="text-danger m-0 mt-2">{{ err.price }}</p>
            </div>
            ...
            <div class="col-md-6">
              ...
              <p v-if="err.condition" class="text-danger m-0 mt-2">{{ err.condition }}</p>
            </div>
            ...
            <div class="col-md-6">
              ...
              <p v-if="err.story" class="text-danger m-0 mt-2">{{ err.story }}</p>
            </div>
            ...
            <div class="col-md-6">
              ...
              <p v-if="err.detail" class="text-danger m-0 mt-2">{{ err.detail }}</p>
            </div>
              ...
              <div class="transaction-wrapper p-3 bg-light rounded-4 form-card-height d-flex flex-column">
                <div class="file-status rounded-3 px-3 py-2 mb-3 d-flex align-items-center justify-content-between"
                  ...
                  <div class="d-flex align-items-center text-truncate">
                    <FileImage v-if="previewUrl && !isDefaultImage" size="20" color="green" class="me-2" />
                  ...
                  <i v-if="!isDefaultImage" class="bi bi-x-circle fs-5 text-danger pointer" @click="removeFile"></i>
                </div>

                <div class="upload-box rounded-3 text-center position-relative overflow-hidden py-2 flex-grow-1"
                  :class="{ 'has-image': previewUrl, dragover: isDragging }" @click="isDefaultImage ? openFile() : null"
                  ...
                  <div v-if="previewUrl" class="preview-container h-100">
                    ...
                    <div class="preview-overlay d-flex align-items-center justify-content-center gap-3">
                      <button v-if="!isDefaultImage" type="button" class="action-icon-btn shadow-sm"
                        data-bs-toggle="modal" data-bs-target="#previewModal" @click.stop>
                        <Eye :size="20" />
                      </button>
                      <button type="button" class="action-icon-btn shadow-sm" @click.stop="openFile">
                        <Upload :size="20" />
                      </button>
                      <button v-if="!isDefaultImage" type="button" class="action-icon-btn btn-delete shadow-sm"
      ...
      <div class="modal shadow-none border-0" id="previewModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="modal-dialog modal-fullscreen m-0 border-0">
          <div class="modal-content bg-transparent border-0">
            <div class="modal-header border-0 px-4 py-3 d-flex align-items-center">
              <div class="d-flex align-items-center text-white me-auto text-truncate" style="max-width: 80%">
            ...
            <div class="modal-body d-flex align-items-center justify-content-center p-0">
              <img v-if="previewUrl && !isDefaultImage" :src="previewUrl" class="img-fluid rounded-2 shadow-lg"
