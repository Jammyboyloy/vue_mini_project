            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div>
                        ...
                        <Transition name="swap" mode="out-in">
                            <!-- Has file -->
                            <div v-if="txn.transaction_file" key="file-row"
                                ...
                                <div class="d-flex align-items-center justify-content-center rounded-2 flex-shrink-0">
                                    <file-image :class="['text-main']" :style="{
                                        fontSize: '1.25rem',
                ...
                " />
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <span class="text-muted" style="font-size: 0.68rem">drag & drop or click to
                                        browse</span>
                                </div>
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                                ...
                                <button
                                    ...
                                    <div class="flex-grow-1">
                                        <span class="d-block fw-bold"
                                            :style="{ color: txn.is_delivery === 1 ? '#ffffff' : '#42b883' }">Pick
                                            Up</span>
                                        <span class="d-block "
                                            :style="{ color: txn.is_delivery === 1 ? '#ffffff' : 'gray' }">Customer
                                            collects order</span>
                                    </div>
                                    <div v-if="txn.is_delivery === 1"
                            ...
                            <div class="col-6">
                                <button
                                    ...
                                    <div class="flex-grow-1">
                                        <span class="d-block fw-bold"
                                            :style="{ color: txn.is_delivery === 2 ? '#ffffff' : '#42b883' }">Delivery</span>
                                        <span class="d-block"
                                            :style="{ color: txn.is_delivery === 2 ? '#ffffff' : 'gray' }">Ship to
                                            address</span>
                                    </div>
                                    <div v-if="txn.is_delivery === 2"
                                        class="d-flex align-items-center justify-content-center rounded-circle flex-shrink-0 check-circle">
                                        <check />
                                    </div>
                                </button>
                            ...
                            <div v-if="txn.is_delivery">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="text-uppercase text-muted fw-semibold">
                                        {{ txn.is_delivery === 1 ? "Pick-up Location" : "Delivery Address" }}
                                    </span>
                                    <Transition name="badge-pop">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <span class="d-block fw-medium text-truncate"
                                                    style="font-size: 0.82rem;">{{
                                                        localPlace }}</span>
                                                <span class="d-block text-main" style="font-size: 0.62rem">Tap Edit to
                ...
                <div class="col-lg-5">
                    ...
                    <div class="mt-5">
                                ...
                                <Transition name="map-fade" mode="out-in">
                                    ...
                                    <div v-else key="empty"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-0 lh-base" style="font-size: 0.68rem">
                        ...
                        <div class="d-flex align-items-start gap-2 mt-2 ms-4">
                            <info class="flex-shrink-0 mt-1" style="font-size: 0.72rem" size="18" />
                            <span class="text-muted mt-1" style="font-size: 0.669rem; line-height: 1.5">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit"
                                class="btn bg-btn d-flex align-items-center gap-2 fw-bold px-4 py-3 rounded-5">
...
watch(() => txn.value.file_object, (newFile) => {
